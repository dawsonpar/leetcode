...
type of the ith sandwich in the stack (i = 0 is the top of the stack)
...
- Once no more students want the top sandwich then we cannot distribute sandwiches and are left with students without lunch
